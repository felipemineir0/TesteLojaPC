...
(function(t) {
    t.extend(t.fn, {validate: function(e) {
        ...
        }, messages: {required: "Esse campo é obrigatório.", remote: "Corrija este campo.", email: "Por favor digite um email válido.", url: "Por favor digite uma URL válida.", date: "Por favor digite uma data valida.", dateISO: "Por favor insira uma data válida (ISO).", number: "Por favor, digite um número valido.", digits: "Por favor insira apenas dígitos.", creditcard: "Por favor insira um número de cartão de crédito válido.", equalTo: "Por favor, insira o mesmo valor novamente.", maxlength: t.validator.format("Máximo de {0} caracteres."), minlength: t.validator.format("Mínimo de {0} caracteres."), rangelength: t.validator.format("Por favor insira um valor entre {0} e {1} caracteres."), range: t.validator.format("Por favor insira um valor entre {0} e {1}."), max: t.validator.format("Digite um valor menor ou igual a {0}."), min: t.validator.format("Digite um valor maior ou igual a {0}.")}, autoCreateRanges: !1, prototype: {init: function() {
                function e(e) {
