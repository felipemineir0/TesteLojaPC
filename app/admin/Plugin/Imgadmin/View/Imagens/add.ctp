        ...
        <div class="media">
            <?php foreach ($files as $file): ?>
                <div class="pull-left">
                    <?php
                    echo $this->Html->link(
                            $this->Html->image('/upload/' . $pasta . '/thumb/' . $file, array('class' => 'img-polaroid')
                            )
                            , '/upload/' . $pasta . '/medio/' . $file, array('class' => 'img', 'escape' => false, 'data-url' => $file)
                    );
                    ?>
                    ...
                    $('.plupload').pluploadQueue({
                        ...
                        preinit: {
                            ...
                            FileUploaded: function (up, file, info) {
                                ...
                                var html = '<a href="<?php echo $this->Html->url('/upload'); ?>/<?php echo $pasta; ?>/medio/' + obj.cleanFileName + '" class="img" data-url="' + obj.cleanFileName + '"><img src="<?php echo $this->Html->url('/upload'); ?>/<?php echo $pasta; ?>/thumb/' + obj.cleanFileName + '" class="img-polaroid" alt=""></a>';
                                $('.media').append(html);
                            },
                        }
...
<?php if (isset($_GET['CKEditor']) || isset($_GET['elementid'])): ?>
    ...
    <?php if (isset($_GET['CKEditor'])): ?>
                                url = '<?php echo $cms['base_url']; ?>/upload/<?php echo $pasta; ?>/' + $(this).data('pasta') + '/' + url;
...
<?php endif; ?>
                ...
                $('.remove a').live('click', function () {
                    ...
                    if (confirm('Tem certeza que quer apagar esta imagem?')) {
                        $.ajax({
                            url: '<?php echo $this->Html->url('/imgadmin/'); ?>' + 'Imagens/remove/' + este.data('url'),
                            success: function () {
