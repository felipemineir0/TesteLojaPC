        ...
        <div class='box'>
            <div class='box-content'>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label" for="arquivo">Vídeo atual</label>
                    <div class="col-md-5 controls">
                        <?php echo $this->Html->image($this->request->data['AlbunsVideo']['imagem'], array("heigth" => 128, "width" => 128)); ?>
                    </div>
                </div>
